...
const en: RestaurantCopy = {
  hero: {
    ...
    meta: ["Open daily · 7 AM – 10 PM", "Breakfast · Lunch · Dinner", "Walk-ins & reservations"],
  },
  chef: {
    eyebrow: "The chef",
    ...
    cards: [
      {
        ...
        cta: "View Food Menu →",
        image: "/images/restaurant-dining-nygPbVtS.jpg",
      },
      {
        key: "drinks",
        title: "Drink Menu",
  ...
  ambiance: {
    ...
    body: "Breakfast with the surf, long lunches under the palms, and dinners where the only sound is the ocean and the string lights overhead. Whatever the hour, the table is set a few steps from the water.",
    slides: [
      { src: "/images/restaurant-view-WsRnSUPN.jpg", alt: "Beachfront dining by day" },
      { src: "/images/restaurant-dining-nygPbVtS.jpg", alt: "A plated dish at Vivace" },
      { src: "/images/restaurant-cocktails-ITbgxYoM.jpg", alt: "Cocktails at the bar" },
...
const es: RestaurantCopy = {
  hero: {
    ...
    whatsappCta: "WhatsApp",
    image: "/images/restaurant-night-DDkbFUTM.jpg",
    meta: ["Abierto todos los días · 7 AM – 10 PM", "Desayuno · Almuerzo · Cena", "Con o sin reserva"],
  },
  chef: {
    eyebrow: "El chef",
  ...
  ambiance: {
    ...
    body: "Desayunos con las olas, almuerzos largos bajo las palmas y cenas donde lo único que se escucha es el océano y las luces de guirnalda. A cualquier hora, la mesa está puesta a unos pasos del agua.",
    slides: [
      { src: "/images/restaurant-view-WsRnSUPN.jpg", alt: "Comedor frente al mar de día" },
      { src: "/images/restaurant-dining-nygPbVtS.jpg", alt: "Un plato emplatado en Vivace" },
      { src: "/images/restaurant-cocktails-ITbgxYoM.jpg", alt: "Cócteles en el bar" },
