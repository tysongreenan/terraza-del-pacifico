...
const en: RestaurantCopy = {
  hero: {
    ...
    image: "/images/resort/dining/1L6A2551.jpg",
    ...
    cards: [
      {
        ...
        cta: "View Food Menu →",
        image: "/images/resort/dining/chloemurdochphotography-314.JPG",
      },
      {
        key: "drinks",
        title: "Drink Menu",
  ...
  ambiance: {
    ...
    slides: [
      { src: "/images/resort/grounds/b7f96664.jpg", alt: "Open-air beachfront restaurant dining room" },
      { src: "/images/resort/grounds/Breakfast lunch and dinner spot.webp", alt: "Restaurant terrace and lawn beside the Pacific" },
      { src: "/images/resort/dining/restaurant-dining-nygPbVtS.jpg", alt: "Beachfront dining by day" },
      { src: "/images/resort/dining/restaurant-view-2-Cv55rCA1.jpg", alt: "The restaurant open to the Pacific" },
      { src: "/images/resort/dining/1L6A2507.jpg", alt: "Soup served at a restaurant table" },
      { src: "/images/resort/dining/1L6A2511.jpg", alt: "Tomato soup with croutons" },
      { src: "/images/resort/dining/1L6A2515.jpg", alt: "Fresh appetizer and tropical drink" },
      { src: "/images/resort/dining/1L6A2526.jpg", alt: "Tuna appetizer at the table" },
      { src: "/images/resort/dining/1L6A2529.jpg", alt: "Guest dining with tuna appetizer" },
      { src: "/images/resort/dining/1L6A2547.jpg", alt: "Plated steak with vegetables" },
      { src: "/images/resort/dining/1L6A2550.jpg", alt: "Steak entree with salad" },
      { src: "/images/resort/dining/1L6A2551.jpg", alt: "Steak entree with tropical drink" },
      { src: "/images/resort/dining/1L6A2555.jpg", alt: "Entree viewed from above" },
      { src: "/images/resort/dining/1L6A2560.jpg", alt: "Skewer over quinoa salad" },
      { src: "/images/resort/dining/1L6A2563.jpg", alt: "Quinoa salad with skewer" },
      { src: "/images/resort/dining/1L6A2576.jpg", alt: "Fish with vegetables and sauce" },
      { src: "/images/resort/dining/chloemurdochphotography-207.JPG", alt: "Two pizzas on serving boards" },
      { src: "/images/resort/dining/chloemurdochphotography-312.JPG", alt: "Dressing poured over a seafood salad" },
      { src: "/images/resort/dining/chloemurdochphotography-320.JPG", alt: "Steak dinner with red wine" },
      { src: "/images/resort/dining/chloemurdochphotography-973.JPG", alt: "Lobster dish with wine by the pool" },
      { src: "/images/resort/dining/chloemurdochphotography-2932.JPG", alt: "Cocktails at the bar" },
      { src: "/images/resort/dining/chloemurdochphotography-602.JPG", alt: "Tacos and beer" },
  ...
  reserve: {
    ...
    primary: "WhatsApp Us",
    image: "/images/resort/dining/1L6A2634.jpg",
  },
};
...
const es: RestaurantCopy = {
  ...
  ambiance: {
    ...
    slides: [
      { src: "/images/resort/grounds/b7f96664.jpg", alt: "Comedor abierto del restaurante frente al mar" },
      { src: "/images/resort/grounds/Breakfast lunch and dinner spot.webp", alt: "Terraza del restaurante y jardin junto al Pacifico" },
      { src: "/images/resort/dining/restaurant-dining-nygPbVtS.jpg", alt: "Comedor frente al mar de día" },
      { src: "/images/resort/dining/restaurant-view-2-Cv55rCA1.jpg", alt: "El restaurante abierto hacia el Pacífico" },
      { src: "/images/resort/dining/1L6A2507.jpg", alt: "Sopa servida en una mesa del restaurante" },
      { src: "/images/resort/dining/1L6A2511.jpg", alt: "Sopa de tomate con crutones" },
      { src: "/images/resort/dining/1L6A2515.jpg", alt: "Entrada fresca y bebida tropical" },
      { src: "/images/resort/dining/1L6A2526.jpg", alt: "Entrada de atun en la mesa" },
      { src: "/images/resort/dining/1L6A2529.jpg", alt: "Comensal con entrada de atun" },
      { src: "/images/resort/dining/1L6A2547.jpg", alt: "Plato de carne con vegetales" },
      { src: "/images/resort/dining/1L6A2550.jpg", alt: "Carne con ensalada" },
      { src: "/images/resort/dining/1L6A2551.jpg", alt: "Carne con bebida tropical" },
      { src: "/images/resort/dining/1L6A2555.jpg", alt: "Plato principal visto desde arriba" },
      { src: "/images/resort/dining/1L6A2560.jpg", alt: "Brocheta sobre ensalada de quinoa" },
      { src: "/images/resort/dining/1L6A2563.jpg", alt: "Ensalada de quinoa con brocheta" },
      { src: "/images/resort/dining/1L6A2576.jpg", alt: "Pescado con vegetales y salsa" },
      { src: "/images/resort/dining/chloemurdochphotography-207.JPG", alt: "Dos pizzas en tablas de servir" },
      { src: "/images/resort/dining/chloemurdochphotography-312.JPG", alt: "Aderezo servido sobre ensalada de mariscos" },
      { src: "/images/resort/dining/chloemurdochphotography-320.JPG", alt: "Cena de carne con vino tinto" },
      { src: "/images/resort/dining/chloemurdochphotography-973.JPG", alt: "Langosta con vino junto a la piscina" },
      { src: "/images/resort/dining/chloemurdochphotography-2932.JPG", alt: "Cocteles en el bar" },
      { src: "/images/resort/dining/chloemurdochphotography-602.JPG", alt: "Tacos y cerveza" },
