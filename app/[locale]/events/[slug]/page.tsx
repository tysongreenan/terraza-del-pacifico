...
export async function generateMetadata({
  ...
  if (isOtherEventsSlug(l, slug)) {
    return {
      ...
      alternates: {
        canonical: `/${l}/events/${otherEventSlugs[l]}`,
        languages: {
          "es-CR": `/es/events/${otherEventSlugs.es}`,
          "en-US": `/en/events/${otherEventSlugs.en}`,
          "x-default": `/es/events/${otherEventSlugs.es}`,
        },
      },
      openGraph: {
        title: otherEventsHub.title[l],
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify(
              faqJsonLd(page.faq.map((f) => ({ q: f.q[l], a: f.a[l] })))
            ),
          }}
        />
      ) : null}
